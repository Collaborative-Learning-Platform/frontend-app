...
//                         {quiz.title}
//                       </Typography>
//                       {quiz.completed && <CheckCircle sx={{ fontSize: 20, color: theme.palette.success.main }} />}
//                     </Box>
//                     <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2 }}>
//                       {quiz.description}
//                     </Typography>
//                     <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', alignItems: 'center' }}>
//                       <Chip label={quiz.difficulty} size="small" color={getDifficultyColor(quiz.difficulty) as any} />
...
//                         <Chip icon={<TrendingUp />} label={`${quiz.score}%`} size="small" color="success" />
//                       )}
//                     </Box>
//                   </Box>
...
//                         '&:hover': {
//                           bgcolor: quiz.completed ? `${theme.palette.primary.main}0A` : theme.palette.secondary.dark,
